...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif,COUNT(i.kitapno) FROM ogrenci AS o INNER JOIN islem AS i ON o.ogrno = i.ogrno WHERE o.sinif IN ('10A','10B')\n" +
            "GROUP BY o.ad,o.soyad,o.sinif";
    ...
    String QUESTION_9 = "SELECT o.ad,o.soyad,COUNT(i.ogrno) FROM ogrenci o INNER JOIN islem i ON o.ogrno = i.ogrno GROUP BY o.ad,o.soyad";
